...
export default function BgLayout({ children, title = "About Us" }: DecorativeBackgroundProps) {
  return (
        ...
        <div className="relative w-[300px] h-[120px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-3xl font-bold" style={{ 
              ...
              textShadow: '0 0 10px rgba(255, 51, 102, 0.5), 0 0 20px rgba(51, 204, 255, 0.3)'
            }}>
              {title}
            </h1>
          </div>
