    ...
    if (isLoading) return (
        <div className="container mx-auto px-4 py-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {[...Array(3)].map((_, i) => (
                    <Card key={i} className="bg-gray-800/50 border-gray-700 rounded-lg overflow-hidden w-full max-w-[320px] mx-auto">
        ...
        <div className="container mx-auto px-4 py-8 text-center">
            <Card className="bg-red-900/20 border-red-700/50 max-w-md mx-auto">
                <CardContent className="p-6">
                    <h2 className="text-xl font-bold text-red-400 mb-3">Error Loading Beads</h2>
                    <Button 
                        variant="outline" 
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="text-center mb-8">
                <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Your Bead Inventory</h1>
                <p className="text-gray-300 text-sm sm:text-base max-w-2xl mx-auto">
                    Manage your bead collection with ease
                </p>
                <Badge variant="outline" className="mt-3 bg-gray-800/50 text-gray-300 border-gray-600 text-xs sm:text-sm p-3">
                            ...
                            {bead.qrCode && hoveredBead === bead._id && (
                                <div className="absolute inset-0 bg-black/90 flex flex-col items-center justify-center p-4 transition-opacity duration-300">
                                    <div className="bg-white p-3 rounded-lg flex flex-col items-center">
                                        ...
                                        />
                                        <p className="text-black mt-2 text-xs sm:text-sm font-medium">Scan QR Code</p>
                                    </div>
