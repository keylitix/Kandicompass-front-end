...
const BeadPage = () => {
  ...
  const beadId = Array.isArray(params.charmsId)
    ? params.charmsId[0]
    : params.charmsId;
              ...
              <div className="w-full lg:w-[80%] mx-auto space-y-4 text-white">
                <div className="flex">
                  ...
                  <span className="w-1/2 text-end">
                    {filteredBead.beadName || 'Royal Sapphire'}
                  </span>
                </div>
                <div className="flex">
                  <span className="w-1/2 flex justify-between">
                    Miles Travelled<span>:</span>
                  </span>
                  <span className="w-1/2 text-end">1,500 miles</span>
                </div>
                <div className="flex">
                  <span className="w-1/2 flex justify-between">
                    Total Hands-off<span>:</span>
                  </span>
                  <span className="w-1/2 text-end">6</span>
                </div>
                <div className="flex">
                  <span className="w-1/2 flex justify-between">
                    Locations Visited<span>:</span>
                  </span>
