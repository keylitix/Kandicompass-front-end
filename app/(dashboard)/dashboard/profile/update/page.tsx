                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <ErrorMessage name="location.city" component="div" className="text-[#FF005D] text-sm mt-1" />
                                        </div>
                                    </div>
...
const extractCountry = (components: google.maps.GeocoderAddressComponent[]): string => {
