  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-48 overflow-hidden">
        ...
        />
        <div className={`absolute inset-0 bg-gradient-to-r from-[#FF005D] to-[#00D1FF] opacity-30 transition-opacity duration-500 
                        ${isHovered ? 'opacity-50' : 'opacity-30'}`}></div>
        
        <div className={`absolute inset-0 border-2 border-[#00D1FF] rounded-lg opacity-0 
                        transition-all duration-700 shadow-[0_0_20px_rgb(255,0,93)]
                        ${isHovered ? 'opacity-70 scale-95' : 'opacity-0 scale-100'}`}></div>
      </div>
