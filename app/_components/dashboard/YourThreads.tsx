...
export const YourThreads: React.FC = () => {
    const router = useRouter();
    const ownedThreads = mockThreads.filter(thread => thread.ownerId === 'u1');
    const joinedThreads = mockThreads.filter(thread => thread.ownerId !== 'u1');
        ...
        <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                ...
                <div
                    ...
                    onClick={() => { router.push('/dashboard/charms/charms-upload') }}
                >
                    <div className="w-14 h-14 rounded-full bg-[#1c102b] bg-opacity-50 flex items-center justify-center mb-4">
                        <Plus size={24} className="text-gradient" style={{ color: '#00D1FF' }} />
                    </div>
