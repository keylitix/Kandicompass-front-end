...
export const WelcomeCollectors: React.FC = () => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-[#1c102b]  border border-[#3f2e6a] rounded-xl p-5">
                    ...
                    <div className="text-xs">
                        <span className="text-green-500">+2</span> new acquisitions in Beads this month
                    </div>
                </div>
                ...
                <AddThread isOpen={openThread} onClose={() => setOpenThread(false)} />
            </div>
    );
};
