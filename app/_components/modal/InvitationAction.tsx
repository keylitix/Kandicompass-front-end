...
const InvitationAction: React.FC<InvitationActionProps> = ({ isOpen, onClose, inviteId, threadName, onSuccessResponse }) => {
            ...
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent>
                    ...
                    <div className="mt-4 text-gray-300 text-sm">
                        You've been invited to join the thread <h3 className="font-bold">"{threadName}".</h3> Would you like to accept or decline this invitation?
                    </div>
