        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-0">
          <div className="w-full pl-0 lg:pl-[90px] pt-[100px] lg:mt-[-100px] space-y-4">
            ...
            <p className="font-sans text-white font-medium text-sm sm:text-base md:text-sm">
              Discover the story of your Kandi charms as they travel <br />{' '}
              across the globe. We are looking to market this more as <br /> an
              experience rather than the charms themselves.
            </p>
