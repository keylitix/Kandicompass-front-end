...
import HomeScreen from '../_components/feed/home';

export const metadata: Metadata = {
  title: 'Beads Social Feed | Connect with Travelers',
  description: 'Explore the most traveled beads, follow journeys, and connect with the community through our interactive social feed.',
  keywords: 'beads, travel, social network, community, journey tracking',
  openGraph: {
    title: 'Beads Social Feed | Connect with Travelers',
    description: 'Explore the most traveled beads, follow journeys, and connect with the community.',
    images: ['/og-image.jpg'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Beads Social Feed',
    description: 'Explore the most traveled beads and follow journeys',
